...
document.addEventListener("DOMContentLoaded", () => {
    ...
    window.loadCategories = async function() {
        ...
        try {
            ...
            const needsEnglishMigration = !localStorage.getItem("migrated_to_english_cats_v5");
            const needsAdditionalSLMigration = !localStorage.getItem("migrated_additional_sl_v3");
            ...
            if ((!hasAlphabet || hasTagalogCats || needsFilipinoLessonsMigration || !hasCompleteAdditionalSL || needsEnglishMigration || needsAdditionalSLMigration) && typeof seedDatabase === "function") {
                ...
                await seedDatabase();
                localStorage.setItem("migrated_to_english_cats_v5", "true");
                localStorage.setItem("migrated_additional_sl_v3", "true");
